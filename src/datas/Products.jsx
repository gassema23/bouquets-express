const Products = [
  {
    category: "Célébration intermédiaire",
    price: 15.99,
    instructions:
    ...
    photo: [
      "./img/Items/items_1.png",
      "./img/Items/items_1-1.png",
      "./img/Items/items_1-2.png",
    ],
    name: "Azalea",
    productId: 1,
    sale: 50,
